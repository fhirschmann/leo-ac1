...
def main():
    ...
    parser.add_argument("command", choices=("islands", "ridges", "inlays"))
    parser.add_argument("names", nargs="*")
    parser.add_argument("--committed", action="store_true", help="analyse the committed STL folders instead of build/")
    parser.add_argument("--layer", type=float, default=0.2, help="islands: layer height")
    parser.add_argument("--min-area", type=float, default=None,
                        help="smallest finding in mm2 (islands 0.05, ridges/inlays 0.1)")
