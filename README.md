...
| ![Charge module](img/08_charge_module.png?v=071f901ea871) | ![LED pocket](img/09_led.png?v=5c52239f3472) |
...
| `chg_holder` charge module holder | 1 | PETG grey | 30 × 17.8 × 14.7 | socket rims on the bed; its two sockets enclose the two pads on the partition and are glued over them, it grips only the cool OUT end of the charge module with two snap hooks |
...
4. Screw the fan on from behind with M3 × 32 (blowing forward) and route its cable through the upper notch of the partition. Put CA gel into the two sockets of the grey charge module holder and push it over the two pads on the partition until they bottom in the sockets, its foot on the ledge below. Stick the heatsink with its insulating pad onto the metal pad on the back of the charge module, then clip the module IN end up into the holder from the fan side: OUT end on the lip, both long edges under the hooks. To take the fan out later, spread the hooks and pull the module out, unscrew the fan, pull it 1 mm back off the air duct, slide it about 11 mm to the left past the holder and take it out towards the back.
