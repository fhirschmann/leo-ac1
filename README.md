...
| M3 × 16, ISO 7380 Torx | 2 | – | service cover, from outside into inserts in the right wall, head in a 1.9 mm pocket (0.25 mm below the face) |
...
3. Slide the PWM board in from behind, potentiometer edge first, onto the two ribs above the electronics shelf; push the potentiometer through the right side wall and tighten its nut outside; screw the service cover on from outside with M3 × 16; push the knob through the hole in the service cover onto the shaft (pointer line towards the flat of the shaft): its slotted stem clamps on the shaft, if it still turns loose add a drop of glue.
...
- Heat-set inserts in the front keep at least 3 mm of material to the visible face (grille 3.4 mm, fan 3.2 mm), so the front does not warp when pressing them in; the service cover inserts are pressed in from outside into bosses with a 1.5 mm closed floor inside.
