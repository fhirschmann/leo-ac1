...
| Rückseite | Explosionsansicht | Typenschild und Rillen |
|---|---|---|
| ![Rückseite](img/02_back.png) | ![Explosion](img/03_exploded.png) | ![Typenschild](img/04_front_right.png) |

## Teile

| Teil | Menge | Material | Maße (mm) | Drucklage |
|---|---|---|---|---|
| `body` Gehäuse | 1 | PETG weiß + grau (Typenschild) | 225 × 155 × 77,6 | Front aufs Bett, Typenschild als Einlage in den ersten 0,6 mm, Zierrillen 0,8 mm tief zur Bettseite offen |
...
Rechnerisch **ca. 0,4 kg und 11,2 Stunden** (diagnostisches Slicen, jede Instanz als eigener Druck; Gehäuse allein 261 g / 6,3 h).
