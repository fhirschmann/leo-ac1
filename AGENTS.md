...
- `analyze.py thickness` finds one wall under 1.2 mm, intended: the 0.8 mm skin in front of the LED; plus a single 1.06 mm sample on the bail where the 1 mm eye chamfer meets the Ø 7 bushing bore (1.5 mm at the face, the pressed-in bushing backs it). The potentiometer wall under washer and nut is 1.8 mm; the switch-well wall 1.56 mm across its 45° flanks.
