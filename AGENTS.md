...
- TPU feet screwed (2 × M3 × 8 each) into outside-pressed inserts; folding bail like the user's leoino case: arms in full-depth steps (9.8 × 12 mm) along both top side edges, pivots at mid-depth (user: level carrying), folds back (user) with the bar 0.5 mm behind the back cover, 34.5 mm finger room, 206 mm grip; M4 × 12 through Ø 7 × 6.9 sleeves into Ruthex M4 inserts (5.1 mm engaged); top back-cover bosses moved inwards beside the steps, back-cover lip and corners cut for the steps; swing sampled at 45° and 90° as extra assembly bodies; swing the bail up before the back cover comes off (back_off path); M5 insert in the underside.
