...
- Accepted bridges: `overhangs back` reports the 14 mm (bar) and 11.8 mm (legs) bridges that close the bail recess (about 3600 mm², test_right_back about 1300 mm²); both ends are supported, the slicer prints them without supports.
