...
- Printer Bambu Lab H2S, PETG Basic white/grey, TPU for the feet. Housing white, grille/cover/handle/knob grey.
...
| Battery BMS | approx. 20 wide over the full cell length, 4 thick | width measured (approx.), thickness **assumed**; cable exit open |
| PWM module PCB | 41.05 × 32.00 | measured; PCB thickness assumed 1.6 |
...
| Rocker switch | 20.90 × 14.70, depth 23.00 incl. contacts, cut-out 19.20 × 12.20, panel approx. 1.50 | measured; depth split before/behind the flange **assumed** |
